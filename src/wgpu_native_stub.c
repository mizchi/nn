...
WGPUBindGroupLayout wgpu_native_device_create_bind_group_layout_9(
  WGPUDevice device,
  int binding0,
  int visibility0,
  int type0,
  ...
  fill_bind_group_layout_entry(&entries[6], binding6, visibility6, type6);
  fill_bind_group_layout_entry(&entries[7], binding7, visibility7, type7);
  fill_bind_group_layout_entry(&entries[8], binding8, visibility8, type8);
...
WGPUBindGroup wgpu_native_device_create_bind_group_9(
  WGPUDevice device,
  WGPUBindGroupLayout layout,
  int binding0,
  WGPUBuffer buffer0,
  ...
  entries[7].offset = (uint64_t)offset7;
  entries[7].size = (uint64_t)size7;
  entries[8].binding = (uint32_t)binding8;
  entries[8].buffer = buffer8;
  entries[8].offset = (uint64_t)offset8;
  entries[8].size = (uint64_t)size8;
